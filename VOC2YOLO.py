...
def convert_annotation(image_id):
    in_file = open('data/voc2012/Annotations/%s.xml' %image_id)
    out_file = open('data/voc2012/Annotations//%s.txt' %image_id, 'w')
...
test_file = open(os.path.join(wd, "val.txt"), 'w')
train_file.close()
test_file.close()
train_file = open(os.path.join(wd, "train.txt"), 'a')
test_file = open(os.path.join(wd, "val.txt"), 'a')
